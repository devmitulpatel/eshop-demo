...
CREATE TABLE `currency` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `currency_currency_status_index` (`currency_status`)
) ENGINE=InnoDB AUTO_INCREMENT=134 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

DROP TABLE IF EXISTS `current_currencies`;
...
DROP TABLE IF EXISTS `delivery_slot_settings`;
...
DROP TABLE IF EXISTS `delivery_time_s_lots`;
...
DROP TABLE IF EXISTS `installtion_settings`;
...
CREATE TABLE `payment_settings` (
  ...
  `public_key` text COLLATE utf8mb4_unicode_ci COMMENT 'flutter public key',
  `status` tinyint(4) NOT NULL DEFAULT '1',
...
DROP TABLE IF EXISTS `social_creadentials`;
...
DROP TABLE IF EXISTS `sub_category_brands`;
...
(1, 'admin', 'admin@groco.com', '$2y$10$zXjrCkWKfH82sMeP5y9VhOQRK/pttxbAm4YMWkv2bZlBRT.IL0kEC', 0, 1, NULL, 'avatar5f69f574acf1c.png', 1, NULL, '2020-09-22 18:30:36');
INSERT INTO `admins` (`id`, `name`, `email`, `password`, `admin_area_id`, `role_id`, `reset_token`, `avatar`, `status`, `created_at`, `updated_at`) VALUES
(2, 'Sales Admin', 'sales@groco.com', '$2y$10$1RQLkt852c.hPobY4Esz6eZ2jzBuJgW81DYpdX/eVnYtM08FL2R/i', 5, 2, NULL, 'avatar5f8c29c39651b.jpeg', 1, '2020-10-18 17:10:51', '2020-10-18 17:10:51');


INSERT INTO `brands` (`id`, `brand_name`, `brand_native_name`, `brand_logo`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Lakeme', 'lakeme', '61aadb58244e8.jpeg', 1, '2021-12-04 08:37:04', '2021-12-04 08:37:04');




INSERT INTO `categories` (`id`, `category_name`, `category_native_name`, `icon`, `home_view`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Makeup', 'Makeup', '61aadae0bdf90.jpeg', 1, 1, '2021-12-04 08:35:04', '2021-12-04 08:35:04');




INSERT INTO `coupons` (`id`, `coupon_code`, `amount_type`, `amount`, `max_amount_limit`, `valid_date`, `status`, `created_at`, `updated_at`) VALUES
(1, 'LLLLLL', 1, 67, 67, '2020-10-16', 1, '2020-10-06 12:18:10', '2020-10-06 12:18:10');
INSERT INTO `coupons` (`id`, `coupon_code`, `amount_type`, `amount`, `max_amount_limit`, `valid_date`, `status`, `created_at`, `updated_at`) VALUES
(2, 'SADIN', 2, 10, 50, '2020-10-18', 1, '2020-10-14 17:02:44', '2020-10-14 17:02:44');
...
(30, 'Cyprus', 'Euro', 'EUR', '€', 0, 1, NULL, '2020-05-12 04:49:27'),
...
(110, 'Spain', 'Euro', 'EUR', '€', 0, 1, NULL, '2020-02-08 23:43:59'),
(111, 'Sri Lanka', 'Rupees', 'LKR', '₨', 0, 1, NULL, '2020-02-03 01:48:58'),
(112, 'Sweden', 'Kronor', 'SEK', 'kr', 0, 1, NULL, NULL),
(113, 'Switzerland', 'Francs', 'CHF', 'CHF', 0, 1, NULL, '2020-02-03 04:05:58'),
...
(124, 'United States of America', 'Dollars', 'USD', '$', 1, 1, NULL, '2020-11-10 17:26:25'),
(125, 'Uruguay', 'Pesos', 'UYU', 'u', 0, 1, NULL, '2020-02-03 00:50:55'),
(126, 'Uzbekistan', 'Sums', 'UZS', 'лв', 0, 1, NULL, NULL),
(127, 'Vatican City', 'Euro', 'EUR', '€', 0, 1, NULL, '2020-02-03 23:14:40'),
(128, 'Venezuela', 'Bolivares Fuertes', 'VEF', 'Bs', 0, 1, NULL, '2020-02-03 01:48:46'),
(129, 'Vietnam', 'Dong', 'VND', '₫', 0, 1, NULL, '2020-02-08 23:44:06'),
(130, 'Yemen', 'Rials', 'YER', '﷼', 0, 1, NULL, NULL),
(131, 'Zimbabwe', 'Zimbabwe Dollars', 'ZWD', 'Z$', 0, 1, NULL, '2020-02-03 00:50:40'),
(133, 'Bangladesh', 'bangladeshi taka', 'BDT', '৳', 0, 1, '2020-02-03 00:08:33', '2020-11-10 17:26:25');
...
(7, '2pm - 3pm', '13:20:00', 1, '2020-10-05 17:17:59', '2020-10-06 10:58:19'),
(9, '4pm - 5pm', '15:30:00', 1, '2020-10-06 11:00:14', '2020-10-06 11:00:14'),
(10, '5pm - 6pm', '16:30:00', 1, '2020-10-06 11:01:14', '2020-10-06 11:01:14'),
(12, '08 am - 09 am', '07:30:00', 1, '2020-10-18 16:44:23', '2020-10-18 16:44:23');
...
(1, '018343942160183439431501834394216', 1, '2020-10-19 10:35:50', '2020-10-19 10:35:50');
...
(33, 6, 'Slider', NULL, 'slider.index', 10, 1, '2020-07-10 09:05:22', '2020-07-10 09:05:23'),
...
(1, '147855768574821', 0, NULL, '2021-12-04 08:49:59');
...
(1, 1001, 1, 1, NULL, 0, 1, NULL, NULL, 1, 2, 140, 120, 240, 280, 0, 0, 0, '2021-12-04 08:50:43', '2021-12-04 08:50:43');
...
(1001, 1, 0, '09662611234', '+1 (643) 829-7044', NULL, 'Ground Floor,Executive Quarters\r\nNear New District Court,Athwalines Road\r\nAthwalines', 1, 40, 2, 280, 240, NULL, NULL, 0, 0, 'pay_ITFZv1UDQNqfs7', 'order_ITFZE2UDLk4wvL', 1, 5, NULL, 'bc384e6814cffe49a23372262308c2f5875e666228152ce27e4ca9ab77117896', '2021-12-04', '2021-12-05', '9am - 10am', '2021-12-04', '2021-12-04', 0, 0, NULL, 3, '2021-12-04 08:50:43', '2021-12-04 09:02:42');
INSERT INTO `orders` (`id`, `user_id`, `location_id`, `customer_name`, `phone`, `email`, `address`, `shipping_area_id`, `shipping_amount`, `total_item`, `total_amount`, `total_buying_amount`, `cupon`, `cash_back`, `discount`, `coupon_discount`, `payment_id`, `payer_id`, `payment_status`, `payment_method`, `card_type`, `validation_id`, `order_date`, `customer_delivery_date`, `customer_delivery_time`, `payment_date`, `delivery_date`, `delivered_by`, `confirmed_by`, `note`, `status`, `created_at`, `updated_at`) VALUES
(1002, 1, 0, '09662611234', '+1 (643) 829-7044', NULL, 'Ground Floor,Executive Quarters\r\nNear New District Court,Athwalines Road\r\nAthwalines', 1, 40, 0, 280, 0, NULL, NULL, 0, 0, 'pay_ITFWr7PtI6a99L', 'order_ITFVkx4I75Hlmz', 1, 5, NULL, '818aeeb2112c08ba6e60948790083b03f2bcf6619d492e99b74cff7046cdd09c', '2021-12-04', '2021-12-05', NULL, '2021-12-04', NULL, 0, 0, NULL, 2, '2021-12-04 08:51:17', '2021-12-04 09:02:21');


INSERT INTO `pages` (`id`, `title`, `description`, `publish`, `created_at`, `updated_at`) VALUES
(1, 'Terms & Condition', '<p>Terms and Conditions agreements act as a legal contract between you (the company) who has the website or mobile app and the user who access your website and mobile app.</p><p>Having a Terms and Conditions agreement is completely optional. No laws require you to have one. Not even the super-strict and wide-reaching General Data Protection Regulation (<a href=\"https://termsfeed.com/blog/gdpr/\" rel=\"noopener noreferrer\" target=\"_blank\">GDPR</a>).</p><p>It\'s up to you to set the rules and guidelines that the user must agree to. You can think of your Terms and Conditions agreement as the legal agreement where you <strong>maintain your rights</strong> to exclude users from your app in the event that they abuse your app, where you maintain your legal rights against potential app abusers, and so on.</p><p>Terms and Conditions are also known as Terms of Service or Terms of Use.</p>', 1, '2020-10-18 16:29:04', '2020-10-18 16:29:04');
INSERT INTO `pages` (`id`, `title`, `description`, `publish`, `created_at`, `updated_at`) VALUES
(2, 'Privacy Policy', '<p>Terms and Conditions agreements act as a legal contract between you (the company) who has the website or mobile app and the user who access your website and mobile app.</p><p>Having a Terms and Conditions agreement is completely optional. No laws require you to have one. Not even the super-strict and wide-reaching General Data Protection Regulation (<a href=\"https://termsfeed.com/blog/gdpr/\" rel=\"noopener noreferrer\" target=\"_blank\">GDPR</a>).</p><p>It\'s up to you to set the rules and guidelines that the user must agree to. You can think of your Terms and Conditions agreement as the legal agreement where you <strong>maintain your rights</strong> to exclude users from your app in the event that they abuse your app, where you maintain your legal rights against potential app abusers, and so on.</p><p>Terms and Conditions are also known as Terms of Service or Terms of Use.</p>', 1, '2020-10-18 16:29:18', '2020-10-18 16:29:18');
...
(1, 'Cash on Delivery', '', '', 'abc', 1, 1, '2020-04-23 22:15:09', '2020-04-23 22:15:12');
INSERT INTO `payment_settings` (`id`, `provider`, `client_id`, `client_secret`, `public_key`, `status`, `live_status`, `created_at`, `updated_at`) VALUES
(2, 'paypal', 'AXhhMYItOyEdhEUJCF-wFASr9JGyPFd1f38jv32OtDzrxPiKUwBTLV9ewjgJJuZb8C_G7Nh-YXOil-vj', 'EF8JKcIf4YOMKtYTLBPiEx9VPenq6qiv5DNXlpJkDuPlIMUCYi16B08RDuLOY8r1VriMRNG563x_InvS', 'abc', 0, 0, '2020-04-12 15:50:49', '2021-12-04 08:43:38');
INSERT INTO `payment_settings` (`id`, `provider`, `client_id`, `client_secret`, `public_key`, `status`, `live_status`, `created_at`, `updated_at`) VALUES
(3, 'stripe', 'pk_test_76vAdtoXsSBtYoxrZNCQAFPm007T5F0FL6', 'sk_test_6mdHPx4HzdfgvHl03vQeeKB500lLcs7oAy', 'abc', 0, 0, '2020-04-12 15:50:50', '2020-10-18 16:31:35');
INSERT INTO `payment_settings` (`id`, `provider`, `client_id`, `client_secret`, `public_key`, `status`, `live_status`, `created_at`, `updated_at`) VALUES
(4, 'ssl-commerz', 'limme5e92958f76c27', 'limme5e92958f76c27@ssl', 'abc', 0, 0, '2020-04-12 15:50:45', '2021-12-04 08:43:44'),
(5, 'Razorpay', 'rzp_test_bcfGJA92uND5FW', 'eQwMbEITVeX0O4gzgLrC6bgE', 'abc', 1, 1, '2020-07-03 18:29:11', '2021-12-04 08:54:37'),
(6, 'Flutterwave', 'FLWSECK_TEST-e527bac3669759b9dccb8152d72bd638-X', '2B5sHo2BbgRt9vnf6vaoSZk2', 'FLWPUBK_TEST-3796e2f4e0ada89eb3583850b4017924-X', 0, 1, '2020-07-03 18:29:11', '2020-10-18 16:31:48');

INSERT INTO `permissions` (`id`, `role_id`, `menu_id`, `created_at`, `updated_at`) VALUES
(115, 1, 8, '2020-10-08 12:11:02', '2020-10-08 12:11:02');
INSERT INTO `permissions` (`id`, `role_id`, `menu_id`, `created_at`, `updated_at`) VALUES
(116, 1, 9, '2020-10-08 12:11:02', '2020-10-08 12:11:02');
INSERT INTO `permissions` (`id`, `role_id`, `menu_id`, `created_at`, `updated_at`) VALUES
(117, 1, 1, '2020-10-08 12:11:02', '2020-10-08 12:11:02');
INSERT INTO `permissions` (`id`, `role_id`, `menu_id`, `created_at`, `updated_at`) VALUES
(118, 1, 31, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(119, 1, 25, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(120, 1, 27, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(121, 1, 26, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(122, 1, 24, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(123, 1, 7, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(124, 1, 33, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(125, 1, 28, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(126, 1, 39, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(127, 1, 15, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(128, 1, 16, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(129, 1, 17, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(130, 1, 18, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(131, 1, 19, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(132, 1, 20, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(133, 1, 21, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(134, 1, 22, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(135, 1, 23, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(136, 1, 6, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(137, 1, 5, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(138, 1, 29, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(139, 1, 30, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(140, 1, 4, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(141, 1, 14, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(142, 1, 37, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(143, 1, 36, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(144, 1, 3, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(145, 1, 32, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(146, 1, 34, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(147, 1, 35, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(148, 1, 10, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(149, 1, 13, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(150, 1, 12, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(151, 1, 11, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(152, 1, 2, '2020-10-08 12:11:02', '2020-10-08 12:11:02'),
(153, 2, 33, '2020-10-18 17:10:10', '2020-10-18 17:10:10'),
(154, 2, 28, '2020-10-18 17:10:10', '2020-10-18 17:10:10'),
(155, 2, 23, '2020-10-18 17:10:10', '2020-10-18 17:10:10'),
(156, 2, 22, '2020-10-18 17:10:10', '2020-10-18 17:10:10'),
(157, 2, 15, '2020-10-18 17:10:10', '2020-10-18 17:10:10'),
(158, 2, 19, '2020-10-18 17:10:10', '2020-10-18 17:10:10'),
(159, 2, 20, '2020-10-18 17:10:10', '2020-10-18 17:10:10'),
(160, 2, 21, '2020-10-18 17:10:10', '2020-10-18 17:10:10'),
(161, 2, 39, '2020-10-18 17:10:10', '2020-10-18 17:10:10'),
(162, 2, 6, '2020-10-18 17:10:10', '2020-10-18 17:10:10'),
(163, 2, 5, '2020-10-18 17:10:10', '2020-10-18 17:10:10'),
(164, 2, 30, '2020-10-18 17:10:10', '2020-10-18 17:10:10'),
(165, 2, 4, '2020-10-18 17:10:10', '2020-10-18 17:10:10'),
(166, 2, 37, '2020-10-18 17:10:10', '2020-10-18 17:10:10'),
(167, 2, 36, '2020-10-18 17:10:10', '2020-10-18 17:10:10'),
(168, 2, 14, '2020-10-18 17:10:10', '2020-10-18 17:10:10'),
(169, 2, 3, '2020-10-18 17:10:10', '2020-10-18 17:10:10'),
(170, 2, 32, '2020-10-18 17:10:10', '2020-10-18 17:10:10'),
(171, 2, 12, '2020-10-18 17:10:10', '2020-10-18 17:10:10'),
(172, 2, 13, '2020-10-18 17:10:10', '2020-10-18 17:10:10'),
(173, 2, 11, '2020-10-18 17:10:10', '2020-10-18 17:10:10'),
(174, 2, 10, '2020-10-18 17:10:10', '2020-10-18 17:10:10'),
(175, 2, 2, '2020-10-18 17:10:10', '2020-10-18 17:10:10');



INSERT INTO `product_images` (`id`, `product_id`, `image_name`, `status`, `created_at`, `updated_at`) VALUES
(1, 1, '1638587374_1044.jpeg', 1, '2021-12-04 08:39:34', '2021-12-04 08:39:34');
...
(1, 1, 1, NULL, NULL, 'Test 1 Lipstick', 'Lipstick-1', '61aadbee6a54c.jpeg', NULL, '<p>De mej fjd sj fkds kjf djksd kfj ksd kf kjsd kfj kj j kf ksd kjf kjsd</p>', NULL, 120, 118, '1 kg', 120, 140, 0, 2, 0, 0, 0, 0, 0, 0, 2, 2, 1, 0, 0, 1, '2021-12-04 08:39:34', '2021-12-04 08:50:43');


INSERT INTO `pwa_settings` (`id`, `app_name`, `app_short_name`, `image`, `created_at`, `updated_at`) VALUES
(1, 'Limmerz Shop', 'Limmerz', 'icon-512x512.png', '2020-09-28 17:01:01', '2020-09-28 17:01:01');


INSERT INTO `roles` (`id`, `role_name`, `created_at`, `updated_at`) VALUES
(1, 'Super Admin', NULL, NULL);
INSERT INTO `roles` (`id`, `role_name`, `created_at`, `updated_at`) VALUES
(2, 'Sales Admin', '2020-10-18 17:09:28', '2020-10-18 17:09:28');


INSERT INTO `seo_keywords` (`id`, `seo_setting_id`, `keyword`, `created_at`, `updated_at`) VALUES
(13, 1, 'limmerz', '2021-10-06 16:13:42', '2021-10-06 16:13:42');
INSERT INTO `seo_keywords` (`id`, `seo_setting_id`, `keyword`, `created_at`, `updated_at`) VALUES
(14, 1, 'grocery', '2021-10-06 16:13:42', '2021-10-06 16:13:42');
INSERT INTO `seo_keywords` (`id`, `seo_setting_id`, `keyword`, `created_at`, `updated_at`) VALUES
(15, 1, 'grocery business', '2021-10-06 16:13:42', '2021-10-06 16:13:42');

INSERT INTO `seo_settings` (`id`, `title`, `meta_image`, `sitemap_link`, `keyword`, `author`, `description`, `created_at`, `updated_at`) VALUES
(1, 'Groco | Start Your Own Grocery Today', '615d7dde29be2.jpeg', 'sitemap.com', 'limmerz, grocery, grocery business', 'Limmex Automation', 'Groco is an grocery eCommerce solution for grocery based on laravel and vue.js', '2020-02-08 23:35:09', '2021-10-06 16:13:42');


INSERT INTO `shipping_areas` (`id`, `city`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Gandhinagar', 1, '2021-12-04 08:50:20', '2021-12-04 08:50:20');
...
(1, 200, 40, 1500, 20, 1, 1, '2020-04-18 20:18:42', '2020-10-18 16:33:56');
...
(1, 'Urban Strick', NULL, 'Mumbai', '2020 all right reserve by Million Solutions LLP', '01312447212767', 'sales@urbanstick.com', 'https://facebook.com', 'https://twitter.com', 'https://youtube.com', '61dad50c7be37.png', '61dad50ca87ec.png', '61dad50cabdfd.png', '#a5a58d', 1, 0, 1, 1, '2020-02-10 02:30:06', '2022-01-09 18:00:41');
...
(1, 'facebook', '1256802924708629', '793eeb9bc876ec94526243a212fd2f2e', 1, 1, '2020-04-11 15:39:55', '2020-04-24 22:39:28');
INSERT INTO `social_creadentials` (`id`, `provider`, `app_id`, `app_secret`, `status`, `live_status`, `created_at`, `updated_at`) VALUES
(2, 'google', '500564591191-vcvu4nodvnca5c7nq6tr21fq2hhb0e11.apps.googleusercontent.com', 'FTiJAbCehKbdVWRIcDHDsG0Z', 1, 1, '2020-04-11 15:39:57', '2020-04-24 22:39:32');
INSERT INTO `social_creadentials` (`id`, `provider`, `app_id`, `app_secret`, `status`, `live_status`, `created_at`, `updated_at`) VALUES
(3, 'twitter', 'your_twitter_app_id', 'your_twitter_app_secret', 0, 0, '2020-04-11 15:40:01', '2020-06-01 08:13:41');
...
(1, 1, 'Lipstick', 'Lipstick', '61aadb0536db7.png', 1, 1, '2021-12-04 08:35:41', '2021-12-04 08:35:41');
INSERT INTO `sub_categories` (`id`, `category_id`, `sub_category_name`, `sub_category_native_name`, `icon`, `home_view`, `status`, `created_at`, `updated_at`) VALUES
(2, 1, 'Kit', 'kit', '61aadb15e64d7.png', 1, 1, '2021-12-04 08:35:57', '2021-12-04 08:35:57');
...
(1, 1, 3, 0, 0, NULL, '2020-10-04 11:50:43');


INSERT INTO `user_coupon` (`id`, `user_id`, `coupon_code`, `valid_date`, `is_used`, `is_applied`, `created_at`, `updated_at`) VALUES
(1, 3, 'LLLLLL', '2020-10-16', 1, 1, '2020-10-06 12:18:26', '2020-10-06 12:19:03');
INSERT INTO `user_coupon` (`id`, `user_id`, `coupon_code`, `valid_date`, `is_used`, `is_applied`, `created_at`, `updated_at`) VALUES
(2, 1, 'SADIN', '2020-10-18', 0, 0, '2020-10-14 17:03:19', '2020-10-14 17:03:19');
INSERT INTO `user_coupon` (`id`, `user_id`, `coupon_code`, `valid_date`, `is_used`, `is_applied`, `created_at`, `updated_at`) VALUES
(3, 3, 'SADIN', '2020-10-18', 0, 0, '2020-10-14 17:03:19', '2020-10-14 17:03:19');
...
(1, 'Jeanette Garrison', 'wutab@mailinator.com', '+1 (643) 829-7044', NULL, NULL, NULL, '$2y$10$YRipXu4Bm1wXK/kGbhfTjuoLzPIUI1S9IyMnCRX1hkKI99W9IIgDa', 0, 0, 1, NULL, '2021-12-04 08:41:18', '2021-12-04 08:41:18');
